...
bool isValidEdge(MyMesh _mesh, MyMesh::HalfedgeHandle _heh, double _threshold)
{
	std::list<MyMesh::Vertex> vertices;
	//for (MyMesh::Edge
	MyMesh::VertexHandle v1 = _mesh.vertex(_mesh.vertices_begin(_heh));
}
